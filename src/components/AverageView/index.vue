<template>
  <div class="average-view">
    <div class="left">
      ...
      <div class="total">
        <count-to :start-val="startVal" :end-val="endVal" :duration="1000" separator="," autoplay />
      </div>
      ...
      () => {
        function createOption() {
          if (props.data.data && props.data.data.length) {
            ...
            endVal.value = props.data.data.reduce((prev, curr) => {
              return prev + curr
            })
            startPercent.value = endPercent.value
            endPercent.value = props.data.data[props.data.data.length - 1] / 5000
          }

 ...
 * @Date: 2021-08-05 15:07:59
 * @LastEditors: Please set LastEditors
 * @LastEditTime: 2021-08-05 16:37:12
-->
<template>
  <div class="gdp-timeline-chart-container">
...
export default defineComponent({
  ...
  setup() {
    ...
    function dataFormatter(obj) {
      ...
      let temp
      for (let year = 2002; year <= 2011; year += 1) {
        let max = 0
        let sum = 0
        temp = obj[year]
